export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'cenozic',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Cenozic',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'cenozic.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://cenozic.com',
